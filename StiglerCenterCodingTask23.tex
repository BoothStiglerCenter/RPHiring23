...
Store the collected issue-level data in a \verb|.csv| file. Your resultant spreadsheet should look as follows:

\textit{Inside} a folder named \verb|task1a| save your README (use any widely use text format your desire), code, and spreadsheet as follows:
\begin{itemize}
    \item \verb|task1a_[firstname]_[lastname]_README|
